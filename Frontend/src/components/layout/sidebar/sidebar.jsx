...
import { Plus, Search, FilePlus, X, BookOpen } from 'lucide-react';
    ...
    <>
        ...
        <div className="p-3.5 border-b border-neutral-200/60 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[11px] text-neutral-400 font-medium">Personal Workspace</span>
            </div>
          </div>
          ...
          <button
            type="button"
            onClick={onClose}
            className="md:hidden p-1.5 rounded-lg hover:bg-neutral-200 text-neutral-500 hover:text-neutral-800 transition-colors"
            title="Close sidebar"
          >
            <X className="w-4 h-4" />
          </button>
        ...
        {isSearchOpen ? (
          <div className="relative flex items-center">
            ...
            <button
              ...
              className="p-1 text-neutral-400 hover:text-neutral-700 absolute right-1"
            >
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-2.5 py-1.5 rounded-md hover:bg-neutral-200/60 transition-colors text-left text-neutral-600 font-medium text-xs"
          >
      ...
      <div className="flex-1 overflow-y-auto px-2 py-3">
        <div className="flex items-center justify-between px-2 mb-1.5 text-[11px] font-bold text-neutral-400 tracking-wider uppercase">
          ...
          <button
            ...
            className="p-1 hover:bg-neutral-200 rounded-md text-neutral-500 hover:text-neutral-900 transition-colors"
      ...
      <div className="p-3 border-t border-neutral-200/60 bg-neutral-50/50">
        <button
          type="button"
          onClick={handleCreate}
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-neutral-200 bg-white hover:bg-neutral-100 text-xs font-semibold text-neutral-800 shadow-xs hover:shadow-sm transition-all active:scale-[0.99]"
        >
